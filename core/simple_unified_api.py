"""
Simple Unified API for the Enhanced Tool Calling Framework
...
class SimpleUnifiedToolAPI:
    """
    Simple unified API that orchestrates all components of the Enhanced Tool Calling Framework
    without requiring external dependencies like sentence-transformers or spaCy.
    """
    ...
    def __init__(
        ...
        """
        Initialize the simple unified API.
        
        Args:
            feedback_db_path: Path to feedback database
            default_execution_config: Default execution configuration
        """
        self.tool_selector = SimpleToolSelector()
        self.argument_generator = SimpleArgumentGenerator()
